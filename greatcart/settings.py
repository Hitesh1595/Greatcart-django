...
SECRET_KEY = 'django-insecure-jh+3lne-tt4#46_&3=a_5+ykqap80(latchdl7cfl*w6h^2&h!'
...
# calles custom create super user method from account
...
# server all files to static root 
STATICFILES_DIRS = [
      'greatcart/static',
]
